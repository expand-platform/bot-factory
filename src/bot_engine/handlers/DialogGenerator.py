...
class DialogGenerator:
    ...
    #! На каком-то этапе нужно добавить возможность взаимодействия и получения данных с API (с того же binance)
    # ? ADMIN COMMANDS
    def make_dialog(
        self,
        ...
        #? api service
        api_client: Optional[str] = None,  #? binance, etc
        api_method: Optional[str] = None,  #? get_price, get_balance, etc
        use_api_data: bool = True,  #? use api data in message or not
